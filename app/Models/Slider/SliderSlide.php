...
{
    use HasAuthor, HasStatus, HasMedia, \OwenIt\Auditing\Auditable, \App\Helpers\Translatable, \App\Helpers\HasTranslations, ApiResponse;
    ...
    public array $translatedAttributes = [
        'title', 'slide_url', 'image_id', 'second_title', 'description', 'description_2'
    ];
}
